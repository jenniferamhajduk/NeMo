...
class ConfigContainer:
    ...
    def validate(self):
        ...
        This method should be overridden by subclasses to implement custom validation logic.
        """
        # Call custom validation method if it exists
        if hasattr(self, "validation") and callable(self.validation):
            self.validation()

    def validation(self):
        """
        Custom validation method to be implemented by subclasses.
        This is where users can define their own validation logic.
        """
        pass

    def get(self, key: str, default: Any = None) -> Any:
        """
        Dictionary-style get with default: config.get("attr", default)
    ...
    @classmethod
    def from_yaml(cls: Type[T], yaml_path: str, mode: InstantiationMode = InstantiationMode.STRICT) -> T:
        """
